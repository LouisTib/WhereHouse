...
<?php $__env->startSection('content'); ?>
    ...
    <div class="intro">
        <div class="intro-text">
            ...
            <div class="intro-button">
                <a href="<?php echo e(route('register')); ?>">Register Your Account</a>
            </div>
        </div>
        <img src="<?php echo e(asset('images/WhereHouse.png')); ?>" alt="WhereHouse Logo">
    </div>
    ...
    <div class="section1">
        ...
        <img src="<?php echo e(asset('images/What.png')); ?>" alt="What Section">
    </div>
    ...
    <div class="section3">
        ...
        <img src="<?php echo e(asset('images/Why.png')); ?>" alt="Why Section">
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\louis\vscodeprojects\FinalProject\WhereHouse\resources\views/home.blade.php ENDPATH**/ ?>